...
jQuery(document).ready(function() {
	...
	jQuery('.patterns a').click(function(e) {
		...
		jQuery('body').css('background', 'url(resources/client/themes/switch/images/pattern/' + name + '.png) repeat center center scroll');
	...
	jQuery('.style a').click(function(e) {
		...
		if (name == 'green') {
			...
			jQuery('#callCss').attr('href', 'resources/client/themes/' + name + '/bootstrap.min.css');
		}
