...
<body class="hold-transition sidebar-mini">
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="position-relative mb-4">
										...
										<canvas id="visitors-chart" height="250" width="425"
											class="chartjs-render-monitor"
											style="display: block; height: 200px; width: 340px;"></canvas>
									</div>
								...
								<div class="card-body table-responsive p-0">
									<table class="table table-striped table-valign-middle">
										...
										<tbody>
											<tr>
												<td><img
													src="${pageContext.request.contextPath }/resources/admin/dist/img/default-150x150.png"
	...
	<script
		src="${pageContext.request.contextPath }/resources/admin/dist/js/pages/dashboard3.js"></script>
</body>
</html>
